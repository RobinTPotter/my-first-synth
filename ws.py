# MIN for Waveshare 1.3" IPS LCD Display Module for Raspberry Pi Pico (240x240)
...
def clear(c):
    lcd.fill(c)
width = 240 # Screen size in pixels
height = 240
...
clear(0)
lcd.text("Red",25,5,colour(255,0,0))      # Initial Test
lcd.text("Green",25,15,colour(0,200,0))
lcd.text("Blue",25,25,colour(0,0,255))
lcd.text('1.3" 240x240',25,35,colour(255,255,0))
lcd.show()